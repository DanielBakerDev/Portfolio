...
import { ValidateNumber, ValidateDecimal } from '../validators/validators';
...
export class ProductDetailComponent implements OnInit {
  ...
  constructor(private builder: FormBuilder) {
    ...
    this.rop = new FormControl('', Validators.compose([ValidateNumber, Validators.required]));
    this.eoq = new FormControl('', Validators.compose([ValidateNumber, Validators.required]));
    this.qoh = new FormControl('', Validators.compose([ValidateNumber, Validators.required]));
    this.qoo = new FormControl('', Validators.compose([ValidateNumber, Validators.required]));
