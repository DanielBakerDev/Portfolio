<!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand" href="#">ICheat</a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        ...
        <div class="dropdown float-right" style="margin-right: 20px;">
            <a href="/messages" id="notification-center" class="header-icon btn-icon-link">
        ...
        <div>
            <a class="btn btn-primary float-right" href="/home/create">Create Class</a>
        </div>
    </div>
</nav> -->
<main class="container">
    <aside class="servers" >
        <a href="/home">
            <div class="servers-collection" style="margin-bottom:30px;">
                    <div class="server-icon">
                        <svg viewBox="0 0 24 24" style="color: white;" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
        ...
        <a href="/home/create">
            <div class="servers-collection">
                <div class="server focusable" role="button" aria-label="My Server" aria-selected="true">
                    <div class="server-icon"><img src="../../../assets/img/plus.png" /></div>
                </div>
            </div>
        </a>
    </aside>
