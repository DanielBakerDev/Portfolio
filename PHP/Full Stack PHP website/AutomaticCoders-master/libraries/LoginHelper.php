...
class LoginHelper
{
  ...
  {
    if (isset($_SESSION['automatic_user_id'])) {
    ...
    $str = '<div class="dropdown pull-right p-t-5 m-l-20 b-l b-dashed p-l-20">
              <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="thumbnail-wrapper d32 circular inline">
                  <img src="/uploads/' . $_SESSION["automatic_username"] . '/profile.jpg" alt="" data-src="/uploads/' . $_SESSION["automatic_username"] . '/profile.jpg" data-src-retina="/uploads/' . $_SESSION["automatic_username"] . '/profile.jpg" width="32" height="32">
                </span>
              </button>
